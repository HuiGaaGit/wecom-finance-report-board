...
- 发布包：`artifacts/wecom-finance-report-board-1.1.27.zip`；SHA256：`BFDBAE5288E566C620A015A60E8547285348FE22C209F072A913050928FBA3D2`。本地完整回归 `89/89`，真实浏览器桌面与手机端验收通过。
