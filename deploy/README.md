...
- 当前生产镜像：`aqllm/finance-report-board:1.1.70`（生产验收与回滚信息见 `docs/PRODUCTION_OPERATIONS.md`）
- 当前源码版本：`1.1.70`（顾问年度营收/投入产出比双趋势与本月营收明细下钻）
- 本机端口：`127.0.0.1:3180`
...
`1.1.70` 为顾问姓名增加年度预计营收/投入产出比双趋势下钻，并为本月非零预计营收增加合同编号、项目名称、客户名字和预计营收额明细下钻。接口沿用顾问模块权限与管理员隐藏名单，趋势只枚举已发布营收月份，明细不暴露原工作表其余列。
